//Generated:2019-01-31 19:06:08// 39-497
(function(){
    var o = {
    $: function(el) {
        var x = el || o.divID, p = {
    ...
    (function() {
    var p = "3589321", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3589321||'',
    GUID:window.ftGUID_3589321||'99999999999',
    confID:window.ftConfID_3589321||'0',
    ftReturn: window.ftReturn_3589321||'',
    keyword:window.ftKeyword_3589321||'',
    ftId:window.ftId_3589321||'',
    imp:window.ftImp3589321,
    ftImpId:window.ftImp3589321 && window.ftImp3589321.impID || '',
    campaignID:'103464',
    cID:'99999',
    pID:'3589321',
    creativeID:'2510204',
    exttrack:["https://ad.doubleclick.net/ddm/trackimp/N5776.1981103VIVAKITHETRADEDESK/B22077594.238316728;dc_trk_aid=435568334;dc_trk_cid=111233977;ord=[timestamp];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?","https://d.agkn.com/pixel/4068/?che=[FT_Random]&col=103464,14143,3589321,0,2510204,[%FT_IMPRESSIONID%],[%FT_GUID%]&puid=[%FT_GUID%]"],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/8/103464;3589321;2510204;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://d.agkn.com/pixel/4069/?che=[FT_Random]&col=103464,14143,3589321,,[%FT_CONFID%],,[%FT_GUID%]&l1=https://ad.doubleclick.net/ddm/trackclk/N5776.1981103VIVAKITHETRADEDESK/B22077594.238316728;dc_trk_aid=435568334;dc_trk_cid=111233977;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?https://starbucks.com"],
    placementDescription:'PBTTDDTDTFMBANITPOEPTPCKGTGNAPDAlwaysOnBRENDAN160x600DesktopSZ160x600ASDCMFTFFCASHRTdCPMADAS3PTRCKIVNAIDNACY19Q1VVVGMRC70IAS',
    width:160,
    height:600,
    adType:'custom_rule'.toLowerCase(),
    siteName:'VivakiTheTradeDesk',
    divID:'ftdiv3589321',
    phID:'ftpos3589321',
    frameID:'ftframe3589321',
    expID:'ftexpframe3589321',
    altImgID:'ftalt3589321',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/103464;3589321;2510204;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://d.agkn.com/pixel/4069/?che=[FT_Random]&col=103464,14143,3589321,,[%FT_CONFID%],,[%FT_GUID%]&l1=https://ad.doubleclick.net/ddm/trackclk/N5776.1981103VIVAKITHETRADEDESK/B22077594.238316728;dc_trk_aid=435568334;dc_trk_cid=111233977;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?https://starbucks.com',
    altImg:'http://servedby.flashtalking.com/imp/8/103464;3589321;204;gif;VivakiTheTradeDesk;PBTTDDTDTFMBANITPOEPTPCKGTGNAPDAlwaysOnBRENDAN160x600DesktopSZ160x600ASDCMFTFFCASHRTdCPMADAS3PTRCKIVNAIDNACY19Q1VVVGMRC70IAS/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/103464;3589321;271;pixel;VivakiTheTradeDesk;PBTTDDTDTFMBANITPOEPTPCKGTGNAPDAlwaysOnBRENDAN160x600DesktopSZ160x600ASDCMFTFFCASHRTdCPMADAS3PTRCKIVNAIDNACY19Q1VVVGMRC70IAS/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/358/3589321/2510204/js/j-3589321-2510204.js',
    file:'http://cdn.flashtalking.com/99999/2510204/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?130091629-3589321;2510204;',
    adVis:false ? 1 : 0,
    centreAd:false,
    mvt:true,
    segment:window.ftSegment_3589321||'',
    segmentList:window.ftSegmentList_3589321||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3589321 && window.ftImp3589321.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3589321')&&/^https:/.test(document.getElementById('ftscript_m3589321').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3589321'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3589321'],
        ['ftcfid', 'ftConfID_3589321'],
        ['fttime', 'ftTimestamp_3589321'],
        ['ftsection', 'ftSection_3589321'],
        ['ftcustom', 'ftCustom_3589321'],
        ['ft_id', 'ftId_3589321'],
        ['ftimpid','ftImp3589321', 'impID']
    ]
};
