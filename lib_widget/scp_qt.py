...
class Ui_scp_qt(object):
    def setupUi(self, scp_qt):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 219, 121))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 367, 302))
        ...
        self.keyEncrypted = QtWidgets.QCheckBox(self.groupBox_4)
        self.keyEncrypted.setEnabled(False)
        self.keyEncrypted.setObjectName("keyEncrypted")
        self.gridLayout_18.addWidget(self.keyEncrypted, 0, 2, 1, 1)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 762, 576))
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 362, 275))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 98, 90))
        ...
        self.keyEncrypted_get = QtWidgets.QCheckBox(self.groupBox_8)
        self.keyEncrypted_get.setEnabled(False)
        self.keyEncrypted_get.setObjectName("keyEncrypted_get")
        self.gridLayout_46.addWidget(self.keyEncrypted_get, 0, 2, 1, 1)
        ...
        self.actionGenerate_RSA_Keys = QtWidgets.QAction(scp_qt)
        self.actionGenerate_RSA_Keys.setShortcutContext(QtCore.Qt.ApplicationShortcut)
        self.actionGenerate_RSA_Keys.setObjectName("actionGenerate_RSA_Keys")
        ...
        self.menuTools.addAction(self.actionGenerate_RSA_Keys)
    ...
    def retranslateUi(self, scp_qt):
        ...
        self.keyEncrypted.setText(_translate("scp_qt", "Encrypted"))
        ...
        self.keyEncrypted_get.setText(_translate("scp_qt", "Encrypted"))
        ...
        self.menuTools.setTitle(_translate("scp_qt", "&Tools"))
        ...
        self.actionGenerate_RSA_Keys.setText(_translate("scp_qt", "&Generate RSA Keys"))
        self.actionGenerate_RSA_Keys.setStatusTip(_translate("scp_qt", "Generate RSA Key Dialog"))
        self.actionGenerate_RSA_Keys.setShortcut(_translate("scp_qt", "F1", "F1"))
